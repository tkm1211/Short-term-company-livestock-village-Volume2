...
struct TexData
{
	...
	DirectX::XMFLOAT2 tex; // テクスチャ切り取り座標
	DirectX::XMFLOAT2 size; // テクスチャ切り取りサイズ
};
...
public:
	SpriteBatch(const wchar_t*, size_t _maxInstance = 1 , DirectX::XMFLOAT2 _cutOutSize = DirectX::XMFLOAT2(0.0f,0.0f));
	~SpriteBatch();
